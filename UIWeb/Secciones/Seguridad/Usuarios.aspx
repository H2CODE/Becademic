                ...
                <div class="modal-body">
                    <!-- Cuerpo de la ventana -->
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control validate[required,minSize[2],ajax[cedulaUnica]]" id="txtCedula_agregar" placeholder="Escriba aquí la cedula..." />
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control validate[required,minSize[2],custom[cenfotecEmail],ajax[correoUnico]]" id="txtCorreoUsuario_agregar" placeholder="Escriba aquí el correo..." />
                        </div>
                  ...
                  <!-- Cuerpo de la ventana -->
                    ...
                    <!-- / Espacio oculto para colocar el ID del grupo que se este editando, esto con el fin de poder enviarlo de nuevo a WebService -->
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control validate[required,minSize[2]]" disabled="disabled" id="txtCedula_editar" placeholder="Escriba aquí la cedula..." />
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control validate[required,minSize[2]]" disabled="disabled" id="txtCorreoUsuario_editar" placeholder="Escriba aquí el correo..." />
                        </div>
