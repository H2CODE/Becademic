												...
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" id="txtCorreo" class="form-control validate[required,custom[cenfotecEmail]]" placeholder="Correo universitario" />
															<i class="icon-user"></i>
														</span>
													</label>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="password" id="txtClave" class="form-control validate[required]" placeholder="Contraseña" />
															<i class="icon-lock"></i>
														</span>
													</label>
