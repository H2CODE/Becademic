...
$(function () {
    ...
    **/
    $("#formularioAgregarUsuario").submit(function (e) {
        ...
        if ($("#formularioAgregarUsuario").validationEngine('validate'))
        {
            var nuevoUsuario = {
            ...
            $("#txtNombreUsuario_agregar").val("");
            $("#txtApellidoUsuario_agregar").val("");
            $("#txtCorreoUsuario_agregar").val("");
            $("#txtCedula_agregar").val("");
            $("#txtNombre2_agregar").val("");
            $("#txtApellido2_agregar").val("");
            $("#txtTelefonoUsuario_agregar").val("");
        }
